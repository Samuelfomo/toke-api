...
export const EmployeeLicenseDbStructure = {
  tableName: `${G.tableAp}_employee_licence`,
  attributes: {
    id: {
      ...
      comment: 'Employee licence',
    },
    guid: {
      type: DataTypes.INTEGER,
      allowNull: false,
      unique: { name: 'unique_employee_licence_guid', msg: 'Employee licence GUID must be unique' },
      validate: {
        isInt: true,
        min: 100000,
      },
  ...
  options: {
    ...
    comment: 'Employee licence table',
    indexes: [
      {
        fields: ['guid'],
        name: 'idx_employee_licence_guid',
      },
      {
        fields: ['global_license'],
        name: 'idx_employee_licence_global_license',
      },
      {
        fields: ['employee'],
        name: 'idx_employee_licence_employee',
      },
      {
        fields: ['employee_code'],
        name: 'idx_employee_licence_employee_code',
      },
      {
        fields: ['activation_date'],
        name: 'idx_employee_licence_activation_date',
      },
      {
        fields: ['deactivation_date'],
        name: 'idx_employee_licence_deactivation_date',
      },
      {
        fields: ['last_activity_date'],
        name: 'idx_employee_licence_last_activity_date',
      },
      {
        fields: ['contractual_status'],
        name: 'idx_employee_licence_contractual_status',
      },
      {
        fields: ['declared_long_leave'],
        name: 'idx_employee_licence_declared_long_leave',
      },
      {
        fields: ['long_leave_declared_by'],
        name: 'idx_employee_licence_long_leave_declared_by',
      },
      {
        fields: ['long_leave_declared_at'],
        name: 'idx_employee_licence_long_leave_declared_at',
      },
      {
        fields: ['long_leave_type'],
        name: 'idx_employee_licence_long_leave_type',
      },
      {
        fields: ['long_leave_reason'],
        name: 'idx_employee_licence_long_leave_reason',
      },
      {
        fields: ['computed_billing_status'],
        name: 'idx_employee_licence_computed_billing_status',
      },
      {
        fields: ['grace_period_start'],
        name: 'idx_employee_licence_grace_period_start',
      },
      {
        fields: ['grace_period_end'],
        name: 'idx_employee_licence_grace_period_end',
      },
    ],
  } as ModelOptions,
  validation: {
